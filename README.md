...
This independent Liberu module owns the provider-neutral **Genealogy Collaboration** capability.
...
- Composer package: `liberusoftware/module-genealogy-collaboration`
- Module installer name: `genealogy-collaboration`
- Category: capability
